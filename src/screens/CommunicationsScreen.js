      ...
      const mockCommunications = [
        {
          ...
          description:
            "Si prevede l'arrivo di temporali forti nelle prossime 24 ore. Si raccomanda massima prudenza.",
...
La situazione sarà costantemente monitorata e verranno forniti aggiornamenti tempestivi.`,
        ...
        },
        {
          ...
          description:
            "Esercitazione di protezione civile programmata per il 25 settembre 2024.",
...
La popolazione è invitata a collaborare seguendo le indicazioni del personale autorizzato.`,
        ...
        },
        {
          ...
          description:
            "Ripristinata la viabilità sulla SS106 dopo i lavori di messa in sicurezza.",
...
Ringraziamo la popolazione per la pazienza dimostrata durante i lavori.`,
        ...
        },
        {
          ...
          description:
            "Al via la campagna di prevenzione degli incendi boschivi per la stagione estiva.",
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Avvisi e comunicazioni ufficiali</Text>
      </View>
