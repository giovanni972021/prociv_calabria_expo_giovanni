...
export default function EventsListScreen({ navigation }) {
      ...
      const mockEvents = [
        {
          ...
          description: 'Segnalazione di allagamento sulla SP 123 all\'altezza del km 15. La strada risulta impraticabile per i veicoli.',
          type: 'flood',
          status: 'open',
        ...
        },
        {
          ...
          description: 'Frana che blocca completamente la viabilità sulla strada comunale. Necessario intervento urgente.',
          type: 'landslide',
          status: 'open',
        ...
        },
        {
          ...
          description: 'Principio di incendio in zona boschiva. Fumo visibile dalla strada statale.',
          type: 'fire',
          status: 'open',
        ...
        },
        {
          id: '4',
          title: 'Albero Caduto',
          description: 'Albero caduto sulla carreggiata a causa del vento forte.',
          type: 'obstacle',
          status: 'resolved',
  ...
  const handleEventPress = (event) => {
    Alert.alert(
      event.title,
      `${event.description}\n\nLocalità: ${event.location}\nData: ${formatDate(event.createdAt)}`,
      [
    ...
    >
      ...
      <View style={styles.eventFooter}>
        ...
        <View style={styles.eventBadges}>
          ...
          <View style={[
            styles.statusBadge,
            { backgroundColor: item.status === 'resolved' ? '#34C759' : '#FF6B35' }
          ]}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.mapButton} onPress={() => navigation.goBack()}>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>
              {showMyReports ? 'Nessuna segnalazione trovata' : 'Nessun evento disponibile'}
            </Text>
          </View>
        }
      />
